...
/**
 * A UDF that returns the mean of a raster layer.
 * Example:
 * 		A = load 'mydata' as (raster);
 * 		B = foreach A generate MeanValue(raster#'0');
 * @author Patrick Happ
 * @author Rodrigo Ferreira
 *
 */
public class MeanValue extends EvalFunc<Double> {
     ...
     * @return mean of the layer, or null in case of processing error
     */
	@Override
