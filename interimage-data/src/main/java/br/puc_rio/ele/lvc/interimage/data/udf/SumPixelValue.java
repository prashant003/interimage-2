...
/**
 * A UDF that returns the Sum of a raster layer.
 * Example:
 * 		A = load 'mydata' as (raster);
 * 		B = foreach A generate SumPixelValue(raster#'0');
 * @author Patrick Happ
 *
 */
public class SumPixelValue extends EvalFunc<Double> {
     ...
     * @return sum of the pixel values of a layer, or null in case of processing error
     */
	@Override
