...
/**
 * A UDF that returns the min pixel value of a raster layer.
 * Example:
 * 		A = load 'mydata' as (raster);
 * 		B = foreach A generate MinPixelValue(raster#'0');
 * @author Patrick Happ
 * @author Rodrigo Ferreira
 *
 */
public class MinPixelValue extends EvalFunc<Double> {
     ...
     * @return min pixel value of the layer, or null in case of processing error
     */
	@Override
