<<<<<<< HEAD:interimage-core/src/main/java/br/puc_rio/ele/lvc/interimage/core/graphExample.java
...
public class graphExample {
	...
	public static void main(String[] args) {
		...
		gMortarNode n1 = g.addMortarOperator("script1.pig");
		n1.setJobs_(jobs);
		n1.setClusterSize(cluster_size);
		n1.setProjectName(project_name);
		
		gMortarNode n2 = g.addMortarOperator("script1.pig");
		n2.setJobs_(jobs);
...
// muito interessante para montar um projeto usando mortar
// http://help.mortardata.com/data_apps/build_your_own/developing_a_mortar_project
>>>>>>> upstream/master:interimage-core/src/main/java/br/puc_rio/ele/lvc/interimage/core/operatorgraph/graphExample.java
