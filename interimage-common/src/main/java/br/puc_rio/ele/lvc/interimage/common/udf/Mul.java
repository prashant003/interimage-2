...
/**
 * A UDF that computes the multiplication of n numbers.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (attrib1, ..., attribn);<br>
 * 		B = foreach A generate Mul(attrib1, ..., attribn);
 * @author Rodrigo Ferreira
 *
 */
public class Mul extends EvalFunc<Double> {
