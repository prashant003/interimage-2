...
/**
 * A UDF that returns the smallest surrounding rectangle of a geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (geom);<br>
 * 		B = foreach A generate SSRectangle(geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class SSRectangle extends EvalFunc<DataByteArray> {
     ...
     * @return smallest surrounding rectangle of the geometry
     */
	@Override
	public DataByteArray exec(Tuple input) throws IOException {
		...
		try {			
			...
			return new DataByteArray(new WKBWriter().write(ssRect));
