...
/**
 * A UDF that computes the number of objects of a specific class that exist in the neighborhood of another object.<br>
 ...
 * 		D = filter C by NumberOf(A::geom, A::group,'','classname');<br>
 * @author Rodrigo Ferreira
 */
public class NumberOf extends EvalFunc<Integer> {
