...
/**
 * A UDF that tests whether a geometry is covered by another geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata1' as (geom);<br>
 * 		B = load 'mydata2' as (geom);<br>
 * 		C = SpatialJoin(A,B,2);<br>
 * 		D = filter C by CoveredBy(A::geom,B::geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class CoveredBy extends EvalFunc<Boolean> {
