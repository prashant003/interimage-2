...
/**
 * A UDF that returns the perimeter area ratio of a geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (geom);<br>
 * 		B = foreach A generate PerimeterAreaRatio(geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class PerimeterAreaRatio extends EvalFunc<Double> {
     ...
     * @return perimeter area ratio of the geometry
     */
	@Override
	public Double exec(Tuple input) throws IOException {
		...
		try {			
			...
			return geometry.getLength() / geometry.getArea();
		} catch (Exception e) {
