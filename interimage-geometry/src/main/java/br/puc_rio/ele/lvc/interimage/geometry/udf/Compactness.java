...
/**
 * A UDF that returns the compacity of a geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (geom);<br>
 * 		B = foreach A generate Compacity(geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class Compactness extends EvalFunc<Double> {
     ...
     * @return compacity of the geometry
     */
	@Override
	public Double exec(Tuple input) throws IOException {
		...
		try {			
			...
			return (length/area) / Math.sqrt(area);
		} catch (Exception e) {
