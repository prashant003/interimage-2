...
/**
 * A UDF that returns the shape index of a geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (geom);<br>
 * 		B = foreach A generate ShapeIndex(geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class ShapeIndex extends EvalFunc<Double> {
     ...
     * @return shape index of the geometry
     */
	@Override
	public Double exec(Tuple input) throws IOException {
		...
		try {			
			...
			return length / (4 * Math.sqrt(area));
		} catch (Exception e) {
