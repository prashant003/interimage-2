...
/**
 * A UDF that returns the gyration radius of a geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (geom);<br>
 * 		B = foreach A generate GyrationRadius(geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class GyrationRadius extends EvalFunc<Double> {
