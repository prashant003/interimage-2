...
/**
 * A UDF that returns the smallest surrounding ellipse of a geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (geom);<br>
 * 		B = foreach A generate SSEllipse(geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class SSEllipse extends EvalFunc<DataByteArray> {
     ...
     * @return smallest surrounding ellipse of the geometry
     */
	@Override
	public DataByteArray exec(Tuple input) throws IOException {
		...
		try {			
			...
			return new DataByteArray(new WKBWriter().write(ellipse));
