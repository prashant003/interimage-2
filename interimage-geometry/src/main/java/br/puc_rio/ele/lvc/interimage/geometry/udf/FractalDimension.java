...
/**
 * A UDF that returns the fractal dimension of a geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (geom);<br>
 * 		B = foreach A generate FractalDimension(geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class FractalDimension extends EvalFunc<Double> {
     ...
     * @return fractal dimension of the geometry
     */
	@Override
	public Double exec(Tuple input) throws IOException {
		...
		try {			
			...
			return 2 * (Math.log(length/4) / Math.log(area));
		} catch (Exception e) {
