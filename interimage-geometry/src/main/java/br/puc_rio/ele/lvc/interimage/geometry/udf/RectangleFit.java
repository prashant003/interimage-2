...
/**
 * A UDF that returns the rectangle fit of a geometry.<br><br>
 * Example:<br>
 ...
 *
 */
public class RectangleFit extends EvalFunc<Double> {
     ...
     * @return rectangle fit of the geometry
     */
	@Override
	public Double exec(Tuple input) throws IOException {
		...
		try {			
			...
			return geometry.getArea() / ssRect.getArea();
