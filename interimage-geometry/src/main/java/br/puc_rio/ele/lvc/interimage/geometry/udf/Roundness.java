...
/**
 * A UDF that returns the roundness of a geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (geom);<br>
 * 		B = foreach A generate Roundness(geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class Roundness extends EvalFunc<Double> {
     ...
     * @return roundness of the geometry
     */
	@Override
	public Double exec(Tuple input) throws IOException {
		...
		try {			
			...
			return 1.0 - (area / (Math.PI * Math.pow(radius,2.0)));
		} catch (Exception e) {
