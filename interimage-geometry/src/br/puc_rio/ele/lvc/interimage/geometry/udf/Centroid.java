...
/**
 * A UDF that returns the centroid of a geometry.<br><br>
 * Example:<br>
 * 		A = load 'mydata' as (geom);<br>
 * 		B = foreach A generate Centroid(geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class Centroid extends EvalFunc<DataByteArray> {
	...
	public DataByteArray exec(Tuple input) throws IOException {
		...
		try {
			...
			return new DataByteArray(new WKBWriter().write(geometry.getCentroid()));
		} catch (Exception e) {
