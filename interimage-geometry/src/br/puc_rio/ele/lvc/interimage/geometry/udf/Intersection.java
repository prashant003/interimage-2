...
/**
 * A UDF that computes the intersection between two geometries.<br><br>
 * Example:<br>
 * 		A = load 'mydata1' as (geom);<br>
 * 		B = load 'mydata2' as (geom);<br>
 * 		C = SpatialJoin(A,B,2);<br>
 * 		D = foreach C generate Intersection(A::geom,B::geom);<br>
 * @author Rodrigo Ferreira
 *
 */
public class Intersection extends EvalFunc<String> {
	...
	public String exec(Tuple input) throws IOException {
		...
		try {			
			...
			return geometry1.intersection(geometry2).toText();
		} catch (Exception e) {
