...
/**
 * A UDF that computes the number of objects of a specific class that exist in the neighborhood of another object.<br><br>
 * Example:<br>
 * 		A = load 'mydata1' as (geom);<br>
 * 		B = load 'mydata2' as (geom);<br>
 * 		C = SpatialGroup(A,B,2);<br>
 * 		D = filter C by NumberOf(A::group,'classname');<br>
